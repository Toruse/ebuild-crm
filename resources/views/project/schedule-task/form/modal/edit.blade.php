<div class="modal fade" id="editScheduleTask" tabindex="-1" role="dialog" aria-labelledby="editScheduleTaskLabel">
        ...
        <div class="modal-content">
            {!! Form::open([
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="editScheduleTaskLabel">Edit Task</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            {!! Form::select('bind_users[]', $listBindUsers, null, [
                                'class' => 'form-control input-select-2-multiple-bind-users-edit', 
                                'multiple' => 'multiple',
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="input-group">
                                {!! Form::select('type', $listTaskTypes, null, [
                                    'class' => 'form-control input-select-2-multiple-edit',
                                    'id' => 'task-type-edit',
                                ]) !!}
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="edit-task-to-schedule">Update Task</button>
                </div>
            {!! Form::close() !!}
        </div>
    </div>
