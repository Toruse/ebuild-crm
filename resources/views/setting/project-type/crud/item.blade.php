<tr>
    ...
    <td>
        <a href="{{ route('project-types.edit', ['type' => $type]) }}">
            {{ $type->name }}
        </a>
    </td>
    <td>
        <a href="{{ route('project-types.edit', ['type' => $type]) }}"><i class="fa fa-edit fa-lg"></i></a>
        <a href="{{ route('project-types.show', ['type' => $type]) }}"><i class="fa fa-eye fa-lg"></i></a>
