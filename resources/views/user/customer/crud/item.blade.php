<tr>
    ...
    <td>
        <a href="{{ route('customers.show', ['user' => $user]) }}">
            {{$user->full_name}}
        </a>
    </td>
    <td>
    ...
    <td>
        <a href="{{ route('customers.edit', ['user' => $user]) }}"><i class="fa fa-edit fa-lg"></i></a>
        <a href="{{ route('customers.show', ['user' => $user]) }}"><i class="fa fa-eye fa-lg"></i></a>
