<tr>
    ...
    <td>
        <a href="{{ route('vendors.show', ['user' => $user]) }}">
            {{$user->full_name}}
        </a>
    </td>
    <td>
    ...
    <td>
        <a href="{{ route('vendors.edit', ['user' => $user]) }}"><i class="fa fa-edit fa-lg"></i></a>
        <a href="{{ route('vendors.show', ['user' => $user]) }}"><i class="fa fa-eye fa-lg"></i></a>
