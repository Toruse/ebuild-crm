    ...
    {!! Form::open([
        ...
        <div class="row">
            ...
            <div class="col-lg-6 form-group">
                ...
                {!! Form::text('fax_number', $profile->fax_number, ['class' => 'form-control']) !!}
        ...
        <div class="row">
            <div class="col-lg-6 form-group">
                ...
                {!! Form::select('material_service[]', $listMaterialService, $user->materialServices, [
